...
import { CirclesWithBar } from "react-loader-spinner"; // Corrected import statement
...
const Inventory = () => {
  ...
  useEffect(() => {
    if (cars.length > 0) {
      setSortedCardsData([...cars]);
    }
  }, [cars]);

  useEffect(() => {
    let sortedData = [...sortedCardsData];
    ...
    return (
      <div className="flex items-center justify-center h-screen">
        <CirclesWithBar
          ...
          width="100"
          color="#05C3DD"
          outerCircleColor="#05C3DD"
          innerCircleColor="#05C3DD"
          barColor="#05C3DD"
      ...
      <div className="max-w-[1160px] mx-auto">
        <div className="bg-white py-5 rounded-xl px-5 flex justify-between items-center">
          <p className="font-bold">
            ...
            {sortedCardsData.length} Results
          </p>
          <div>
